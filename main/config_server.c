...
static void config_server_load_cfg(char *cfg)
{
	...
	if(key == 0 || (strlen(key->valuestring) > sizeof(device_config.egmp_car_model)))
	{
		goto config_error;
	}
